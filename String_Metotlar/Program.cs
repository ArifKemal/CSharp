internal class Program
{
    ...
    {
        string degisken = "Ders csharp hosgeldiniz";
        string degisken2 = "ders csharp hosgeldiniz";
        ...
        System.Console.WriteLine(degisken.EndsWith("merhaba"));
        
        //IndexOf
        System.Console.WriteLine(degisken.IndexOf("cs"));
        System.Console.WriteLine(degisken.IndexOf("arif"));
        ...
        System.Console.WriteLine(degisken+degisken2.PadLeft(30,'*'));
        System.Console.WriteLine(degisken.PadRight(30,'0')+degisken2);
        System.Console.WriteLine(degisken.PadRight(30) +degisken2);
